...
try:
    ...
    _stub = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "rich_stub")
...
def run():
    ...
    if controller.ready:
        try:
            ...
            print(e)
            return make_response(f"Exception raised: {e}", 400)
    return make_response("Controller not ready — please Assemble first", 400)
